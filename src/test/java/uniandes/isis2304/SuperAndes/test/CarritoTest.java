...
public class CarritoTest {
	...
	public void unicidadEIntegridadCarritoTest() {
		...
		{
			//			e.printStackTrace();
			log.info ("Prueba de Unicidad e Integridad de Carrito incompleta. No se pudo conectar a la base de datos !!. La excepción generada es: " + e.getClass ().getName ());
		...
		{
			//			e.printStackTrace();
			String msg = "Error en la ejecución de las pruebas de UNICIDAD e INTEGRIDADsobre la tabla Carrito.\n";
			msg += "Revise el log de superAndes y el de datanucleus para conocer el detalle de la excepción";
			System.out.println (msg);
	...
	public void restriccionesChequeoCarritoTest() {
		...
		{
			//				e.printStackTrace();
			log.info ("Prueba de chequeo de Carrito incompleta. No se pudo conectar a la base de datos !!. La excepción generada es: " + e.getClass ().getName ());
			log.info ("La causa es: " + e.getCause ().toString ());
		...
		{
			//				e.printStackTrace();
			String msg = "Error en la ejecución de las pruebas de CHEQUEO sobre la tabla Carrito.\n";
			msg += "Revise el log de superAndes y el de datanucleus para conocer el detalle de la excepción";
			System.out.println (msg);
